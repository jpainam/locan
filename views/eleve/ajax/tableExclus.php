<table class="dataTable" id="exclusTable">
    <thead>
        <tr><th>N°</th><th>Noms et Prénoms</th><th>Date Naiss</th><th>Classes</th><th>Date exclusion</th><th>Action</th></tr>
    </thead>
    <tbody>
        <?php
        $i = 1;
        ...
        foreach ($eleves as $el) {
            ...
            echo "<td>".$d->getDate()."-".$d->getMois(3)."-".$d->getYear()."</td><td>" . $el['NIVEAUHTML'] . "</td>";
